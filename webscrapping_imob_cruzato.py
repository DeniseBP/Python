...
def extrair_e_escrever_dados(url, arquivo):
    ...
    site = requests.get(url, headers=headers)
    soup = BeautifulSoup(site.text, 'html.parser')
    imoveis = soup.find_all('div', class_='imovelcard')
    ...
    with open(arquivo, 'a', newline='', encoding='utf-8') as f:
        ...
        for imovel in imoveis:
            ...
            tipo = tipo_element.get_text(strip=True) if tipo_element else "N/A"
            ...
            if tipo != "N/A":
                ...
                negocio_element = imovel.find(
                    'h2', class_='imovelcard__info__tag')
                ...
                negocio = negocio_element.get_text(
                    strip=True) if negocio_element else "N/A"
                # Aqui estamos tirando também as quebras de linha com o replace
                ...
                url_imagem = correspondencias[-1] if correspondencias else "N/A"
                # segundo_texto_entre_aspas
                link_imovel = 'https://www.cruzatopatrimonio.com.br' + \
                    correspondencias[1] if correspondencias else "N/A"
...
urls = {
    'venda': ('https://www.cruzatopatrimonio.com.br/imovel/?finalidade=venda&tipo=&bairro=0&sui=&ban=&gar=&dor='),

    'locacao': ('https://www.cruzatopatrimonio.com.br/imovel/?finalidade=locacao&tipo=&bairro=0&sui=&ban=&gar=&dor=')

}

# Nome do arquivo CSV
nome_arquivo = 'imoveis_dados_cruzato.csv'

# Limpar o arquivo antes de começar a escrever
arquivo_csv = 'C:\\Users\\Camila\\Desktop\\DENISE\\Projeto_Imob\\imoveis_dados_cruzato.csv'
